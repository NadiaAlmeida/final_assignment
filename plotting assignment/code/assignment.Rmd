...
Other than that it is also good that each piece of the pie chart is accompanied by a label of what it represents and its percentage so that all the relevant information is easily found without having to look around for it. 
Another good feature of this chart is that by using a color palette from the viridis package it can be printed in black and white and color blind people can differentiate between the colors. 
Overall it's a simple pie chart with all the information around each part so that you do not have to search for the information far from the plot.   
